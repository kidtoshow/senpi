                    ...
                    <form method="POST" action="{{ route('update-profile') }}" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="university" id="university" class="form-control form-control-user">
                                    @foreach($Data['universities'] as $university)
                                        <option value="{{$university['value']}}" {{ (Auth::user()->university == $university['value'])?'selected':'' }}>{{$university['label']}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="mb-3">
